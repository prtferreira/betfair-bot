...
public class LayDrawAfterHt00StatusResponse {
  ...
  private List<LayDrawAfterHt00BetRecord> bets = new ArrayList<>();
  ...
  public List<LayDrawAfterHt00BetRecord> getBets() {
    return bets;
  }

  public void setBets(List<LayDrawAfterHt00BetRecord> bets) {
