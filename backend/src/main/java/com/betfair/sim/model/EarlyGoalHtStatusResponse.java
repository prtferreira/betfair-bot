...
public class EarlyGoalHtStatusResponse {
  ...
  private List<EarlyGoalHtBetRecord> bets = new ArrayList<>();
  ...
  public List<EarlyGoalHtBetRecord> getBets() {
    return bets;
  }

  public void setBets(List<EarlyGoalHtBetRecord> bets) {
